...
#$ -o ../logs/log.scen3.jul.txt	 			 ##$ output file name

#$ -N s3jul						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen3_jul.py > ../logs/log.${CMAQ_POL}.scen3.jul.txt
