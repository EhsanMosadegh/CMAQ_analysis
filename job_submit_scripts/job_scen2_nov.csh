...
#$ -o ../logs/log.scen2.nov.txt	 			 ##$ output file name

#$ -N s2nov						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen2_nov.py > ../logs/log.${CMAQ_POL}.scen2.nov.txt
