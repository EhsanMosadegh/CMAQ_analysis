...
#$ -o ../logs/log.scen4.sep.txt	 			 ##$ output file name

#$ -N s4sep						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen4_sep.py > ../logs/log.${CMAQ_POL}.scen4.sep.txt
