...
#$ -o ../logs/log.scen3.oct.txt	 			 ##$ output file name

#$ -N s3oct						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen3_oct.py > ../logs/log.${CMAQ_POL}.scen3.oct.txt
