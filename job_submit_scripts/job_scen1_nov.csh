...
#$ -o ../logs/log.scen1.nov.txt	 			 ##$ output file name

#$ -N s1nov						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen1_nov.py > ../logs/log.${CMAQ_POL}.scen1.nov.txt
