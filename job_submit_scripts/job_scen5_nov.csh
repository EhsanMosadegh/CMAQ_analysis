...
#$ -o ../logs/log.scen5.nov.txt	 			 ##$ output file name

#$ -N s5nov						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen5_nov.py > ../logs/log.${CMAQ_POL}.scen5.nov.txt
