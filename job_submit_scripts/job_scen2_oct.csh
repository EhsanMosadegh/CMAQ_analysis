...
#$ -o ../logs/log.scen2.oct.txt	 			 ##$ output file name

#$ -N s2oct						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen2_oct.py > ../logs/log.${CMAQ_POL}.scen2.oct.txt
