...
#$ -o ../logs/log.scen5.oct.txt	 			 ##$ output file name

#$ -N s5oct						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen5_oct.py > ../logs/log.${CMAQ_POL}.scen5.oct.txt
