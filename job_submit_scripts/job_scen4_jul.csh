...
#$ -o ../logs/log.scen4.jul.txt	 			 ##$ output file name

#$ -N s4jul						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen4_jul.py > ../logs/log.${CMAQ_POL}.scen4.jul.txt
