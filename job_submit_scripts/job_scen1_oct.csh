...
#$ -o ../logs/log.scen1.oct.txt	 			 ##$ output file name

#$ -N s1oct						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen1_oct.py > ../logs/log.${CMAQ_POL}.scen1.oct.txt
