...
#$ -o ../logs/log.scen3.nov.txt	 			 ##$ output file name

#$ -N s3nov						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen3_nov.py > ../logs/log.${CMAQ_POL}.scen3.nov.txt
