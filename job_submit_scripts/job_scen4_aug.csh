...
#$ -o ../logs/log.scen4.aug.txt	 			 ##$ output file name

#$ -N s4aug						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen4_aug.py > ../logs/log.${CMAQ_POL}.scen4.aug.txt
