...
#$ -o ../logs/log.scen5.aug.txt	 			 ##$ output file name

#$ -N s5aug						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen5_aug.py > ../logs/log.${CMAQ_POL}.scen5.aug.txt
