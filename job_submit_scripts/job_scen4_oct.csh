...
#$ -o ../logs/log.scen4.oct.txt	 			 ##$ output file name

#$ -N s4oct						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen4_oct.py > ../logs/log.${CMAQ_POL}.scen4.oct.txt
