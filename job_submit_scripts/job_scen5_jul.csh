...
#$ -o ../logs/log.scen5.jul.txt	 			 ##$ output file name

#$ -N s5jul						##$ name of my job
...
python -u ../run_scripts/spatial_CMAQ_analysis_scen5_jul.py > ../logs/log.${CMAQ_POL}.scen5.jul.txt
